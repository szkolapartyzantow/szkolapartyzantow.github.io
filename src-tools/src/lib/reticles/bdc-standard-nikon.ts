...
const RING_RADIUS_MRAD = 0.9549;
const RING_CENTERS_MRAD = [1.9098, 4.29705, 6.6843004, 10.503901];

const outerPaint = { color: "#ffffff", fill: true };
const linePaint = { color: "#111111", strokeWidth: 1 };
const fillPaint = { color: "#111111", fill: true };

export function drawBdcStandardNikon(canvas: ReticleCanvas, input: ReticleRenderInput): void {
  ...
  canvas.line(centerX, verticalStart, centerX, centerY + 14.323501 * pxPerMrad, linePaint);
