...
export function drawMp8DotIor(canvas: ReticleCanvas, input: ReticleRenderInput): void {
  ...
  canvas.line(centerX, centerY - scaledRadius, centerX, centerY - 0.5 * pxPerMrad, linePaint);
  canvas.line(centerX, centerY + 0.5 * pxPerMrad, centerX, centerY + scaledRadius, linePaint);
  canvas.line(centerX - scaledRadius, centerY, centerX - 0.5 * pxPerMrad, centerY, linePaint);
  canvas.line(centerX + 0.5 * pxPerMrad, centerY, centerX + scaledRadius, centerY, linePaint);
  canvas.circle(centerX, centerY, 0.15 * pxPerMrad, fillPaint);
